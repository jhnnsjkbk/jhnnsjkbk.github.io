...
For a complete and up-to-date list of publications, please visit my [Google Scholar profile](https://scholar.google.com/citations?user=Bz3X5pQAAAAJ&hl=en).

I also contribute to various communities as reviewer, associate editor, and track chair including conferences like NeurIPS, AAAI, ECML, and journals like the Journal of Artificial Intelligence Research.
...
**ICCV 2025** | [Paper](https://arxiv.org/pdf/2504.11171) | [Website](https://ibm.github.io/terramind/) | [Code](https://github.com/ibm/terramind) | [HuggingFace](https://huggingface.co/ibm-esa-geospatial)
...
**arXiv preprint** | [Paper](https://arxiv.org/pdf/2510.23118)

*Task-agnostic framework for multimodal fusion of time series and images for Earth observation.*

### Partial Recovery of Meter-Scale Surface Weather
Giezendanner, J., Yang, Q., Schmitt, E., Chandra, A., Civitarese, DS, **Jakubik, J.**, ... (2026).
**arXiv preprint** | [Paper](https://arxiv.org/abs/2602.23146)

*Deep learning-based super-resolution framework for downscaling coarse-resolution weather forecasts to meter-scale resolution.*

### Local Off-Grid Weather Forecasting with Multi-Modal Earth Observation Data
Yang, Q., Giezendanner, J., Civitarese, DS, **Jakubik, J.**, Schmitt, E., Chandra, A., Vila, J., Hohl, D., Hill, C., Watson, C., Wang, S. (2025).
**Journal of Advances in Modeling Earth Systems** | [Paper](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2025MS005207)

*Multi-modal Earth observation framework for weather forecasting in off-grid and remote locations.*

---

## 📚 Overview on my publications
...
**KDD 2025 (Fragile Earth)** | **Citations: 2**

**Design & Operating Point Dependent Surrogate Models for PMSM**
Digel, C., Jux, B., **Jakubik, J.**, Breining, P., Doppelbauer, M. (2023).
**Elektromechanische Antriebssysteme 2023** | **Citations: 2**

**A Summer School Session on Mastering Geospatial Artificial Intelligence**
Maskey, M., Cavallaro, G., Heras, DB, Fraccaro, P., Edwards, B., Gurung, I., **Jakubik, J.**, et al. (2023).
**IEEE Geoscience and Remote Sensing Magazine** | **Citations: 2**

**Unsupervised Domain Adaptation for Geospatial Semantic Segmentation**
**Jakubik, J.**, Muszynski, M., Vössing, M., Kühl, N., Brunschwiler, T. (2023).
...
**AAAI 2024** | [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/30334) | **Citations: 1**
...
**arXiv preprint arXiv:2603.12762**

**How To Embed Matters: Evaluation of EO Embedding Design Choices**
Glich, L., Wittmann, I., Nitsche, M., **Jakubik, J.**, Ewald, A., Brunschwiler, T. (2026).  
**arXiv preprint arXiv:2603.10658**

**Spectral Gaps and Spatial Priors: Studying Hyperspectral Downstream Adaptation Using TerraMind**
Leonardi, JA, **Jakubik, J.**, Fraccaro, P., Brovelli, MA. (2026).  
**ICLR'26 (ML4RS)**

**Partial Recovery of Meter-Scale Surface Weather**
Giezendanner, J., Yang, Q., Schmitt, E., Chandra, A., Civitarese, DS, **Jakubik, J.**, et al. (2026).  
**arXiv preprint arXiv:2602.23146**

**Phaedra: Learning High-Fidelity Discrete Tokenization for the Physical Sciences**
Lingsch, L., Kissas, G., **Jakubik, J.**, Mishra, S. (2026).  
**arXiv preprint arXiv:2602.03915**

**Downscaling Weather at Arbitrary Locations with Earth Observation Data**
Yang, Q., Giezendanner, J., Civitarese, DS, **Jakubik, J.**, Schmitt, E., Chandra, A., et al. (2025).  
**AGU25**

**Calibrated Probabilistic Wind Forecasting with Diffusion Models**
Yang, Q., Giezendanner, J., Civitarese, DS, **Jakubik, J.**, Schmitt, E., Chandra, A., et al. (2025).  
**AGU25**

**From Pixels to Patterns: TerraMind at Meter Resolution with Weather Context**
**Jakubik, J.**, Blumenstiel, B., Brunschwiler, T., Fraccaro, P., Watson, C., Moreno, J., et al. (2025).  
**AGU'25**

**Multi-Modal Artificial Intelligence Systems**
Mishra, N., **Jakubik, J.**, Spitzer, P., Satzger, G. (2025).  
**Available at SSRN 6135468**

**Sensitivity Analysis for Climate Science with Generative Flow Models**
Dobra, A., Pidstrigach, J., Reichelt, T., Fraccaro, P., Jones, A., **Jakubik, J.**, et al. (2025).  
**NeurIPS 2025 (ClimateChangeAI)**

**Leveraging Neural Compression for Earth Observation**
Wittmann, I., **Jakubik, J.**, Gomes, C., Blumenstiel, B., Brunschwiler, T., et al. (2025).  
**EGU'25**

**Spectral Super-Resolution for Greenhouse Gas Detection**
Gonzalez, R., Blumenstiel, B., Bangalore, R., Braham, NAA, **Jakubik, J.**, et al. (2025).  
**EGU'25**

**FAST-EO: Transforming Earth Observation Through Multi-Modal Foundation Models**
Kuzu, RS, Brunschwiler, T., Cavallaro, G., Nalepa, J., Dumitru, CO, et al. (2025).  
**EGU'25**

**Scalable Efficient Compression in Large-Scale Earth Observation**
Scheurer, E., Wang, J., Sedona, R., Maurogiovanni, S., Blumenstiel, B., et al. (2025).  
**EGU General Assembly Conference Abstracts, EGU25-19016**

**Localized Wind Forecasting Powered by Foundation Models**
Yang, Q., Giezendanner, J., Wang, S., Hill, CN, Watson, C., Salles Civitarese, D., et al. (2024).  
**AGU Fall Meeting Abstracts 2024, GC22A-01**

**Multi-modal Fusion for Localized Wind Forecasting**
Wang, S., Giezendanner, J., Yang, Q., Schmitt, E., Salles Civitarese, D., et al. (2024).  
**AGU Fall Meeting Abstracts 2024, NH41A-02**

**Downstream Applications on Prithvi WxC: A Foundation Model for Weather and Climate**
Schmude, J., Roy, S., Jones, A., **Jakubik, J.**, Kuehnert, J., Singh, S., et al. (2024).  
**AGU Fall Meeting Abstracts 2024, IN51B-01**

**Towards Multi Modal Geospatial Foundation Models With Multiple Resolutions**
Simumba, N., **Jakubik, J.**, Blumenstiel, B., Fraccaro, P. (2024).  
**AGU Fall Meeting Abstracts 2024 (4), IN53D-04**

**Geospatial Foundation Model by Diversified Data**
Kimura, D., Simumba, N., Freitag, M., Schmude, J., Chu, L., Szwarcman, D., et al. (2024).  
...
**Data-centric Artificial Intelligence: Foundations and Methods for Deep Learning**
**Jakubik, J.** (2024).  
**Karlsruher Institut für Technologie (KIT)**

**Assessing Performance of a Foundation Model for Multi-Label Image Classification of Satellite Imagery**
Ahmadi, M., Khallaghi, S., Cecil, M., Roy, S., **Jakubik, J.**, Fraccaro, P., et al. (2023).  
**AGU Fall Meeting Abstracts 2023 (422), IN51C-0422**

**Exploring Effectiveness of Foundation Models for Downstream Applications on Satellite Data**
Alemohammad, H., Li, H., Cecil, M., Khallaghi, S., Godwin, D., Ahmadi, M., et al. (2023).  
**AGU Fall Meeting Abstracts 2023, IN54A-05**

**Evaluating Foundation Models for Crop Type Segmentation Using Multi-temporal Multi-spectral Satellite Imagery**
Khallaghi, S., Li, H., Cecil, M., Kordi, F., Roy, S., **Jakubik, J.**, Fraccaro, P., et al. (2023).  
**AGU Fall Meeting Abstracts 2023, IN53A-06**

**Comparative Analysis of Vision Transformer and CGAN Models for Cloud Gap Filling in Time Series of Satellite Images**
Godwin, D., Cecil, M., Li, H., Roy, S., **Jakubik, J.**, Fraccaro, P., Alemohammad, H. (2023).  
**AGU Fall Meeting Abstracts 2023, GC21A-07**

**Burn Scar Detection Leveraging a Harmonized Landsat and Sentinel-2 Foundation Model**
Phillips, CE, Roy, S., **Jakubik, J.**, Zadrozny, B., Fraccaro, P., Ramachandran, R., et al. (2023).  
**AGU Fall Meeting Abstracts 2023 (441), IN51C-0441**

**Foundation Models for Science: An Open Collaborative Initiative**
Ramachandran, R., Gurung, I., Ramasubramanian, M., Roy, S., Phillips, CE, et al. (2023).  
**AGU Fall Meeting Abstracts 2023, IN53A-01**

**NASA-IBM HLS Foundation Model - Image Segmentation by Foundation Model Finetuning**
**Jakubik, J.**, Chu, L., Fraccaro, P., Bangalore, R., Lambhate, D., Das, K., et al. (2023).  
**https://github.com/nasa-impact/hls-foundation-os**

**Fine-tuning a Geospatial Foundation Model for Environmental Impact Monitoring Tasks**
Zadrozny, B., Bangalore, R., Das, K., Fraccaro, P., Gomes, C., **Jakubik, J.**, et al. (2023).  
**American Geophysical Union (AGU)**

**Evaluation of Surya, a Heliophysics Foundation Model, Using a Wide Range of Downstream Applications**
Muñoz-Jaramillo, A., Bahauddin, S., da Silva, D., Hegde, DV, Hong, J., et al. (2025).  
**AGU25**

**Surya: Foundation Model for Heliophysics using SDO Data**
Roy, S., Schmude, J., Lal, R., Gaur, V., Freitag, M., Kuehnert, J., van Kessel, T., et al. (2025).  
**AGU25**

**AI Foundation Models for Observational and Gridded Data Across Scales**
Schmude, J., **Jakubik, J.**, Civitarese, DS, Singh, S., Roy, S., Maskey, M., et al. (2025).  
**AGU25**
